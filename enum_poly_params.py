...
class BasicEnumPolyParams(metaclass=NormalMetaClass):
            ...
            for pas in pas_manipulated_gen:
                ...
                for pbs_premanipulate in b_params_iterator:
                    ...
                    for pbs in pbs_manipulated_gen:
                        ...
                        if self._avoid_int_roots and any([ self._does_have_integer_roots(pb) for pb in pbs ]):
                            continue
    ...
    def _does_have_integer_roots(poly):
        """For a poly2sympoly of deg(poly2sympoly) < 3 (after factoring out any power of x^n), check if it has integer roots.
        Returns a boolean."""
